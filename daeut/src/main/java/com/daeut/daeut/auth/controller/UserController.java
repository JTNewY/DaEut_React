...
public class UserController {
    ...
    public ResponseEntity<Users> userMypage(HttpSession session) throws Exception {
    ...
    public ResponseEntity<Users> userMypageUpdate(HttpSession session) throws Exception {
    ...
    public ResponseEntity<Void> userMypageUpdateDone(HttpSession session, @RequestParam("action") String action, @RequestBody Users user) throws Exception {
    ...
    public ResponseEntity<List<Orders>> userReservation(HttpSession session) throws Exception {
    ...
    public ResponseEntity<Review> showReviewForm(HttpSession session) {
    ...
    public ResponseEntity<Void> submitReview(HttpSession session,@RequestBody Review review) {
    ...
    public ResponseEntity<Void> createChatRoom(@RequestParam("partnerNo") int partnerNo, HttpSession session) throws Exception {
    ...
    public ResponseEntity<List<ChatRooms>> userChatRooms(HttpSession session) throws Exception {
        Users user = (Users) session.getAttribute("user");
        if (user == null) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
        }
    ...
    // 사용자 장바구니 조회
    @GetMapping("/userCart")
    public ResponseEntity<List<Cart>> userCart(HttpSession session) {
        Users user = (Users) session.getAttribute("user");
        if (user == null) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
        }
    ...
    public ResponseEntity<Partner> userPartner(HttpSession session) throws Exception {
    ...
    public ResponseEntity<Void> insertPartner(@RequestBody Partner partner, HttpSession session) throws Exception {
        Users user = (Users) session.getAttribute("user");
        if (user == null) {
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
        }
